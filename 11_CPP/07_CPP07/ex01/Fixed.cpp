...
/*   Updated: 2021/10/25 11:51:50 by tderwedu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed	Fixed::operator*(Fixed const &rhs) const
{
	...
	res = (long)this->_fpv * (long)rhs.getRawBits() / (long)(1UL << Fixed::_bits);
	ret.setRawBits(res);
	return (ret);
}
...
Fixed	Fixed::operator/(Fixed const &rhs) const
{
	...
	res = (long)this->_fpv * (long)(1UL << Fixed::_bits) / (long)rhs.getRawBits();
	ret.setRawBits(res);
	return (ret);
}
